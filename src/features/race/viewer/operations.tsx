...
export function RaceOperations({ initialData }: {
  ...
  <PlaybackBar controller={controller} playback={playback} rows={rows} reduceMotion={reduceMotion} onReduceMotion={setReduceMotion}/>
